    ...
    No segundo jogo, chamado de Adivinhe o número o jogador terá 5 tentativas parar acertar um número aleatório entre 0 e 1000, ao final da partida, o usuário deve         novamente   guarda um número para que seja usado no final.
